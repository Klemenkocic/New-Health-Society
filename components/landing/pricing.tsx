            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8 md:mb-12">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="relative p-8 rounded-2xl border border-[#293133]/10 bg-[#F3F0E5] text-[#293133] flex flex-col shadow-lg"
                    >
                        ...
                        <div className="flex-grow">
                            <ul className="space-y-4 mb-8">
                                {coachingPlan.features.map(feature => (
                                    <li key={feature} className="flex items-center gap-3 text-sm text-[#293133]/80">
                                        <Check className="w-4 h-4 text-[#26538D]" />
                                        {feature}
                                    </li>
                                ))}
                            </ul>
                        ...
                        <Button variant="glass" className="w-full mt-auto bg-[#26538D] hover:bg-[#26538D]/90 text-white border-none">Get Started</Button>
                    </motion.div>
                    ...
                    >
                        <div className="absolute top-0 right-0 bg-primary text-white text-xs font-bold px-3 py-1 rounded-bl-lg rounded-tr-2xl">
                            PREMIUM
                        </div>
                    ...
                    >
                        ...
                        <div className="flex-grow">
                            <ul className="space-y-4 mb-8">
                                <li className="flex items-center gap-3 text-sm text-[#293133]/80">
                                    <Check className="w-4 h-4 text-[#26538D]" />
                        ...
                        <Button variant="glass" className="w-full mt-auto bg-[#26538D] hover:bg-[#26538D]/90 text-white border-none">Join Group</Button>
                    </motion.div>
                </div>

                {/* SHARED FEATURES */}
                <div className="pt-0">
                    <h4 className="text-center font-serif text-2xl mb-6 text-[#293133]/80">INCLUDED IN ALL MEMBERSHIPS</h4>
                    <div className="flex flex-wrap justify-center items-center gap-3 text-[#293133]/70 font-inter text-sm md:text-base">
