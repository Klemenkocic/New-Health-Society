    ...
    return (
        <section className="py-24 px-6 md:px-12 bg-[#293133] text-[#F3F0E5]">
            <div className="max-w-7xl mx-auto">
                <div className="mb-24 border-b border-[#F3F0E5]/10 pb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
                    ...
                    {/* 3. PERSONAL TRAINING (Dynamic, Highlighted) */}
                    <motion.div
                        initial={{ opacity: 0, y: 20 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true }}
                        transition={{ delay: 0.2 }}
                        className="relative p-8 rounded-2xl border border-primary bg-[#F3F0E5] text-[#293133] flex flex-col"
                    >
